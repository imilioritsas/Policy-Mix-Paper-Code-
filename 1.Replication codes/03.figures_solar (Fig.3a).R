# =========================================================
#   Policy & Non-policy Effects Over Time - Solar (Stacked Area)
# =========================================================
#For running this script, we use the manually created 
#"policy_analysis_solar.xlsx" Excel file;
...
# File path
file_path <- "R:/SFBWISO/RE Deployment/3. To Submit (AIP)/02. Data & Code/policy_analysis_solar.xlsx"
...
custom_colors <- c(
  "FiT/FiP-based" = "#E9A328",                   
  "Other single instrument" = "#E8C53E",               
  "Tax-based" =   "#E5D559",            
  "Tender-based" = "#E2E480",                   
  "Policy mix" =  "#E2E6BD",
...
#save the data needed for the Figure (Figure 3a)
write.csv(yearly_df_clusters, "yearly_effects_solar.csv", row.names = F)
